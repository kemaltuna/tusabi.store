...
def get_library() -> MedQuizLibrary:
    ...
    possible_paths = [
        Path.cwd() / "shared" / "data" / "medquiz_library.json",  # Priority 1: Current/shared
        Path(__file__).parent.parent / "shared" / "data" / "medquiz_library.json", # Priority 2: Relative shared
        Path.cwd() / "data" / "medquiz_library.json", # Priority 3: Legacy local
    ]
